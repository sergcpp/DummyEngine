...
def main():
	...
	base_cmake_cmd = '"' + ANDROID_HOME + '\\cmake\\3.6.4111459\\bin\\cmake"' + ' -G"Android Gradle - Ninja" .. -DANDROID_NDK="' + NDK_ROOT + '" -DCMAKE_BUILD_TYPE=Release -DCMAKE_MAKE_PROGRAM="' + ANDROID_HOME + '\\cmake\\3.6.4111459\\bin\\ninja" -DCMAKE_TOOLCHAIN_FILE="' + NDK_ROOT + '\\build\\cmake\\android.toolchain.cmake" -DANDROID_NATIVE_API_LEVEL=9 -DANDROID_PLATFORM=android-21 -DANDROID_STL=c++_static -DANDROID_CPP_FEATURES="rtti exceptions" -DANDROID_TOOLCHAIN=clang '
	...
	for arch in archs:
		...
		os.chdir("build-android-" + arch)
		os.system('"' + base_build_cmd + 'DemoApp' + '"')
		os.chdir('..')
