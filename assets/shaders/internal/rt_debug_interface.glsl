...
DEF_CONST_INT(BLAS_BUF_SLOT, 8)
DEF_CONST_INT(TLAS_BUF_SLOT, 9)
DEF_CONST_INT(PRIM_NDX_BUF_SLOT, 10)
DEF_CONST_INT(MESHES_BUF_SLOT, 11)
DEF_CONST_INT(MESH_INSTANCES_BUF_SLOT, 12)
