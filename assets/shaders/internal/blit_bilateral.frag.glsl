...
void main() {
    ...
    float center_depth = textureLod(g_depth_texture, norm_uvs, 0.0).r;
    ...
    if(g_params.vertical < 0.5) {
        ...
        depth = textureLod(g_depth_texture, norm_uvs - vec2(texel_size.x, 0), 0).r;
        ...
        depth = textureLod(g_depth_texture, norm_uvs - vec2(2.0 * texel_size.x, 0), 0).r;
        closeness = 1.0 / (0.075 + abs(center_depth - depth));
        ...
        depth = textureLod(g_depth_texture, norm_uvs - vec2(3.0 * texel_size.x, 0), 0).r;
        closeness = 1.0 / (0.075 + abs(center_depth - depth));
        ...
        depth = textureLod(g_depth_texture, norm_uvs - vec2(0, texel_size.y), 0).r;
        closeness = 1.0 / (0.075 + abs(center_depth - depth));
        weight = closeness * 0.189879;
        ...
        depth = textureLod(g_depth_texture, norm_uvs - vec2(0, 2.0 * texel_size.y), 0).r;
        closeness = 1.0 / (0.075 + abs(center_depth - depth));
        weight = closeness * 0.131514;
        ...
        depth = textureLod(g_depth_texture, norm_uvs - vec2(0, 3.0 * texel_size.y), 0).r;
        closeness = 1.0 / (0.075 + abs(center_depth - depth));
        weight = closeness * 0.071303;
