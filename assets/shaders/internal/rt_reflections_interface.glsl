...
DEF_CONST_INT(RAY_COUNTER_SLOT, 9)
DEF_CONST_INT(RAY_LIST_SLOT, 10)
DEF_CONST_INT(SOBOL_BUF_SLOT, 11)
DEF_CONST_INT(SCRAMLING_TILE_BUF_SLOT, 12)
DEF_CONST_INT(RANKING_TILE_BUF_SLOT, 13)
DEF_CONST_INT(LMAP_TEX_SLOTS, 14)
DEF_CONST_INT(OUT_REFL_IMG_SLOT, 19)
DEF_CONST_INT(OUT_RAYLEN_IMG_SLOT, 20)
