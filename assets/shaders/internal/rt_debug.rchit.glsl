...
void main() {
    ...
    pld.col = textureLod(SAMPLER2D(mat.texture_indices[0]), uv, 0.0);
    ...
    if ((geo.flags & RTGeoLightmappedBit) != 0u) {
        ...
        pld.col.xyz *= (direct_lm + indirect_lm);
    } else {
        ...
        //pld.col.xyz = normal * 0.5 + 0.5;
        pld.col.xyz *= EvalSHIrradiance_NonLinear(normal,
