...
#if defined(MSAA_4)
layout(binding = REN_REFL_SPEC_TEX_SLOT) uniform mediump sampler2DMS g_spec_tex;
...
#else
layout(binding = REN_REFL_SPEC_TEX_SLOT) uniform highp sampler2D g_spec_tex;
...
#endif
layout(binding = REN_REFL_DEPTH_LOW_TEX_SLOT) uniform highp sampler2D g_depth_low_tex;
layout(binding = REN_REFL_SSR_TEX_SLOT) uniform highp sampler2D g_ssr_tex;

layout(binding = REN_REFL_PREV_TEX_SLOT) uniform highp sampler2D g_prev_tex;
