...
private:
    ...
    Ren::ProgramRef
        skydome_prog_, fillz_solid_prog_, fillz_vege_solid_prog_, fillz_vege_solid_vel_prog_, fillz_transp_prog_, fillz_vege_transp_prog_, fillz_vege_transp_vel_prog_, shadow_solid_prog_, shadow_vege_solid_prog_, shadow_transp_prog_, shadow_vege_transp_prog_, blit_prog_, blit_ms_prog_, blit_combine_prog_, blit_combine_ms_prog_,
        ...
        blit_rgbm_prog_, blit_mipmap_prog_, blit_prefilter_prog_, blit_project_sh_prog_, blit_fxaa_prog_, blit_taa_prog_, blit_static_vel_prog_,
    ...
    FrameBuf clean_buf_, resolved_or_transparent_buf_, ssr_buf1_, ssr_buf2_, down_buf_, blur_buf1_, blur_buf2_, shadow_buf_, reduced_buf_, ssao_buf1_, ssao_buf2_, probe_sample_buf_, combined_buf_, history_buf_, down_depth_;
    ...
    static const uint32_t default_flags =
        ...
        (EnableZFill | EnableCulling | EnableSSR | EnableSSAO | EnableLightmap | EnableLights | EnableDecals | EnableShadows /*| EnableOIT*/ | EnableTonemap | EnableBloom | EnableMsaa | EnableFxaa | EnableTimers);
#else
    ...
    uint32_t
        temp_framebuf_, skydome_framebuf_ = 0, depth_fill_framebuf_ = 0, depth_fill_framebuf_vel_ = 0, refl_comb_framebuf_ = 0,
        transparent_comb_framebuf_ = 0, clean_buf_color_only_ = 0, clean_buf_vel_only_ = 0, clean_buf_transparent_ = 0, temporal_resolve_framebuf_ = 0;
    ...
    enum { TimeDrawStart, TimeSkinningStart, TimeShadowMapStart, TimeDepthOpaqueStart,
           TimeAOPassStart, TimeOpaqueStart, TimeTranspStart, TimeReflStart, TimeTaaStart,
           TimeBlurStart, TimeBlitStart, TimeDrawEnd, TimersCount };
