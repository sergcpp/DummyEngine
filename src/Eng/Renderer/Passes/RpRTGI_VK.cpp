...
void RpRTGI::ExecuteRTPipeline(RpBuilder &builder) {
    ...
    const Ren::Binding bindings[] = {
        ...
        {Ren::eBindTarget::TBuf, RTGI::SOBOL_BUF_SLOT, *sobol_buf.tbos[0]},
        {Ren::eBindTarget::TBuf, RTGI::SCRAMLING_TILE_BUF_SLOT, *scrambling_tile_buf.tbos[0]},
        {Ren::eBindTarget::TBuf, RTGI::RANKING_TILE_BUF_SLOT, *ranking_tile_buf.tbos[0]},
...
void RpRTGI::ExecuteRTInline(RpBuilder &builder) {
    ...
    VkDescriptorSet descr_sets[2];
    descr_sets[0] = Ren::PrepareDescriptorSet(api_ctx, pi_rt_gi_inline_.prog()->descr_set_layouts()[0], bindings,
                                              COUNT_OF(bindings), ctx.default_descr_alloc(), ctx.log());
    descr_sets[1] = bindless_tex_->rt_inline_textures_descr_set;

    vkCmdBindPipeline(cmd_buf, VK_PIPELINE_BIND_POINT_COMPUTE, pi_rt_gi_inline_.handle());
    vkCmdBindDescriptorSets(cmd_buf, VK_PIPELINE_BIND_POINT_COMPUTE, pi_rt_gi_inline_.layout(), 0, 2, descr_sets, 0,
                            nullptr);
    ...
    vkCmdPushConstants(cmd_buf, pi_rt_gi_inline_.layout(), VK_SHADER_STAGE_COMPUTE_BIT, 0, sizeof(uniform_params),
                       &uniform_params);
