...
class RpSSRReproject : public RenderPassBase {
    bool initialized = false;

    // lazily initialized data
    Ren::Pipeline pi_ssr_reproject_;
  ...
  public:
    ...
    const char *name() const override { return "SSR REPROJECT"; }
};
