...
void RpRTShadows::ExecuteRTPipeline(RpBuilder &builder) {
    ...
    auto *acc_struct = static_cast<Ren::AccStructureVK *>(acc_struct_data_->rt_tlas[1]);
    ...
    const Ren::Binding bindings[] = {{Ren::eBindTarget::UBuf, REN_UB_SHARED_DATA_LOC, *unif_sh_data_buf.ref},
                                     ...
                                     {Ren::eBindTarget::SBuf, RTShadows::VTX_BUF2_SLOT, *vtx_buf2.ref},
...
void RpRTShadows::ExecuteRTInline(RpBuilder &builder) {
    LazyInit(builder.ctx(), builder.sh());
