...
class RpSSRResolveTemporal : public RenderPassBase {
  ...
  public:
    void Setup(RpBuilder &builder, const ViewState *view_state, float glossy_thres, float mirror_thres,
               const char shared_data_buf_name[], const char norm_tex_name[], const char avg_refl_tex_name[],
               const char refl_tex_name[], const char reproj_refl_tex_name[], Ren::WeakTex2DRef variance_tex,
