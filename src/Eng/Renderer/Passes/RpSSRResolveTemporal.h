...
class RpSSRResolveTemporal : public RenderPassBase {
  ...
  public:
    void Setup(RpBuilder &builder, const ViewState *view_state, const char shared_data_buf_name[],
               ...
               const char reproj_refl_tex_name[], Ren::WeakTex2DRef variance_tex, Ren::WeakTex2DRef sample_count_tex,
               const char tile_list_buf_name[], const char indir_args_name[], uint32_t indir_args_off,
               Ren::WeakTex2DRef out_refl_tex, Ren::WeakTex2DRef out_variance_tex);
