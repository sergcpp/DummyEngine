...
class RpSSRResolveTemporal : public RenderPassBase {
    bool initialized = false;

    // lazily initialized data
    Ren::Pipeline pi_ssr_resolve_temporal_;
    ...
    RpResource norm_hist_tex_;
    RpResource rough_hist_tex_;
    RpResource velocity_tex_;
    RpResource refl_tex_;
    RpResource refl_hist_tex_;
    RpResource ray_len_tex_;
  ...
  public:
    void Setup(RpBuilder &builder, const ViewState *view_state, const char shared_data_buf_name[],
               ...
               Ren::WeakTex2DRef norm_hist_tex, Ren::WeakTex2DRef rough_hist_tex, const char velocity_tex_name[],
               const char refl_tex_name[], Ren::WeakTex2DRef refl_hist_tex, const char ray_len_tex_name[],
