...
std::unique_ptr<Ren::IAccStructure> Eng::SceneManager::Build_SWRT_BLAS(const AccStructure &acc) {
    ...
    if (!scene_data_.persistent_data.swrt.rt_blas_buf) {
        ...
        scene_data_.persistent_data.swrt.rt_blas_buf->AddBufferView(Ren::eTexFormat::RGBA32F);
    }
...
void Eng::SceneManager::RebuildLightTree() {
    ...
    { // Init GPU data
        ...
        scene_data_.persistent_data.stoch_lights_nodes_buf->AddBufferView(Ren::eTexFormat::RGBA32F);
