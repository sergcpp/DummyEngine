...
class ExEmissive final : public FgExecutor {
  public:
    ...
    ExEmissive(const DrawList **p_list, const view_state_t *view_state, const BindlessTextureData *bindless_tex,
               const Args *args)
  ...
  private:
    ...
    void LazyInit(const FgContext &fg, Ren::ImageRWHandle color, Ren::ImageRWHandle depth);
