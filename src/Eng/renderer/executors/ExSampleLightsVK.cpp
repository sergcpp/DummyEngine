...
void Eng::ExSampleLights::Execute_HWRT(FgContext &fg) {
    ...
    const Ren::Binding bindings[] = {{Ren::eBindTarget::UBuf, BIND_UB_SHARED_DATA_BUF, *unif_sh_data_buf.ref},
                                     {Ren::eBindTarget::UTBuf, RANDOM_SEQ_BUF_SLOT, *random_seq_buf.ref},
                                     {Ren::eBindTarget::UTBuf, LIGHTS_BUF_SLOT, *lights_buf.ref},
                                     {Ren::eBindTarget::UTBuf, LIGHT_NODES_BUF_SLOT, *nodes_buf.ref},
                                     {Ren::eBindTarget::AccStruct, TLAS_SLOT, *acc_struct},
                                     {Ren::eBindTarget::SBufRO, GEO_DATA_BUF_SLOT, *geo_data_buf.ref},
                                     {Ren::eBindTarget::SBufRO, MATERIAL_BUF_SLOT, *materials_buf.ref},
                                     {Ren::eBindTarget::UTBuf, VTX_BUF1_SLOT, *vtx_buf1.ref},
                                     {Ren::eBindTarget::UTBuf, NDX_BUF_SLOT, *ndx_buf.ref},
                                     {Ren::eBindTarget::TexSampled, ALBEDO_TEX_SLOT, *albedo_tex.ref},
                                     {Ren::eBindTarget::TexSampled, DEPTH_TEX_SLOT, {*depth_tex.ref, 1}},
                                     {Ren::eBindTarget::TexSampled, NORM_TEX_SLOT, *norm_tex.ref},
                                     {Ren::eBindTarget::TexSampled, SPEC_TEX_SLOT, *spec_tex.ref},
                                     {Ren::eBindTarget::ImageRW, OUT_DIFFUSE_IMG_SLOT, *out_diffuse_tex.ref},
                                     {Ren::eBindTarget::ImageRW, OUT_SPECULAR_IMG_SLOT, *out_specular_tex.ref}};
