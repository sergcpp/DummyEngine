...
void Eng::ExGBufferFill::DrawOpaque(FgContext &ctx) {
    ...
    { // Simple meshes
        ...
        { // solid one-sided
            ...
            i = _draw_range_ext2(ctx, materials, *dummy_white.ref, batch_indices, batches, i, 0, cur_mat_id,
                                 &draws_count);
            ...
            i = _draw_range_ext2(ctx, materials, *dummy_white.ref, batch_indices, batches, i, BDB::BitBackSided,
        ...
        { // solid two-sided
            ...
            i = _draw_range_ext2(ctx, materials, *dummy_white.ref, batch_indices, batches, i, BDB::BitTwoSided,
                                 cur_mat_id, &draws_count);
        }
        ...
        { // moving solid one-sided
            ...
            i = _draw_range_ext2(ctx, materials, *dummy_white.ref, batch_indices, batches, i, BDB::BitMoving,
                                 cur_mat_id, &draws_count);
        }
        ...
        { // alpha-tested one-sided
            ...
            i = _draw_range_ext2(ctx, materials, *dummy_white.ref, batch_indices, batches, i, BDB::BitAlphaTest,
                                 cur_mat_id, &draws_count);
        }
    ...
    { // Vegetation meshes
        ...
        { // vegetation solid one-sided
            ...
            i = _draw_range_ext2(ctx, materials, *dummy_white.ref, batch_indices, batches, i, BDB::BitsVege, cur_mat_id,
                                 &draws_count);
        }
