...
#include "rt_diffuse_trace_ss_interface.h"
...
void main() {
    ...
    const vec3 refl_ray_ws = SampleDiffuseVector(g_tcbn_2d_tex, normal_ws, pix_uvs, g_params.frame_index, RAND_DIM_2D_DIFFUSE_0);
    ...
    out_color.w = NormalizeHitDist(out_color.w, -ray_origin_vs.z, 1.0);
