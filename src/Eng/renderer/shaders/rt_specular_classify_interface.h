#ifndef RT_SPECULAR_CLASSIFY_INTERFACE_H
#define RT_SPECULAR_CLASSIFY_INTERFACE_H

#include "_interface_common.h"

INTERFACE_START(RTSpecularClassifyTiles)
...
#endif // RT_SPECULAR_CLASSIFY_INTERFACE_H