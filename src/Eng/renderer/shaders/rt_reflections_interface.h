...
const int MESHES_BUF_SLOT = 9;
const int MESH_INSTANCES_BUF_SLOT = 10;
const int RAY_COUNTER_SLOT = 11;
const int RAY_LIST_SLOT = 12;
const int BLAS_BUF_SLOT = 13;
const int TLAS_BUF_SLOT = 14;
const int NOISE_TEX_SLOT = 15;
const int OIT_DEPTH_BUF_SLOT = 15;
const int LIGHTS_BUF_SLOT = 16;
const int VTX_BUF1_SLOT = 17;
const int VTX_BUF2_SLOT = 18;
const int NDX_BUF_SLOT = 19;
