...
const int TLAS_SLOT = 3;
const int DEPTH_TEX_SLOT = 4;
const int NORM_TEX_SLOT = 5;
const int ENV_TEX_SLOT = 6;
const int GEO_DATA_BUF_SLOT = 7;
const int MATERIAL_BUF_SLOT = 8;
const int VTX_BUF1_SLOT = 9;
const int VTX_BUF2_SLOT = 10;
const int NDX_BUF_SLOT = 11;
const int PRIM_NDX_BUF_SLOT = 12;
const int MESHES_BUF_SLOT = 13;
const int MESH_INSTANCES_BUF_SLOT = 14;
const int RAY_COUNTER_SLOT = 15;
const int RAY_LIST_SLOT = 16;
const int BLAS_BUF_SLOT = 17;
const int TLAS_BUF_SLOT = 18;
