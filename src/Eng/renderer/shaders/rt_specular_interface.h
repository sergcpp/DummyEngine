#ifndef RT_SPECULAR_INTERFACE_H
#define RT_SPECULAR_INTERFACE_H

#include "_interface_common.h"

INTERFACE_START(RTSpecular)
...
const uint VTX_BUF2_SLOT = 17;
const uint NDX_BUF_SLOT = 18;
const uint SHADOW_DEPTH_TEX_SLOT = 19;
const uint SHADOW_COLOR_TEX_SLOT = 20;
const uint LTC_LUTS_TEX_SLOT = 21;
const uint CELLS_BUF_SLOT = 22;
const uint IRRADIANCE_TEX_SLOT = 25;
const uint DISTANCE_TEX_SLOT = 26;
const uint OFFSET_TEX_SLOT = 27;
const uint ITEMS_BUF_SLOT = 28;
const uint STOCH_LIGHTS_BUF_SLOT = 29;
const uint LIGHT_NODES_BUF_SLOT = 30;
const uint RAY_HITS_BUF_SLOT = 31;

const uint CACHE_ENTRIES_BUF_SLOT = 25;
const uint CACHE_VOXELS_BUF_SLOT = 26;
