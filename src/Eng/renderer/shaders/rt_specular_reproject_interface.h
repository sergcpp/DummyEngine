#ifndef RT_SPECULAR_REPROJECT_INTERFACE_H
#define RT_SPECULAR_REPROJECT_INTERFACE_H

#include "_interface_common.h"

INTERFACE_START(RTSpecularReproject)
...
const uint REFL_TEX_SLOT = 8;
const uint REFL_HIST_TEX_SLOT = 9;
...
#endif // RT_SPECULAR_REPROJECT_INTERFACE_H