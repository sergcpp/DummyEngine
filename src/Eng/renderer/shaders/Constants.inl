...
const float SHADOWMAP_CASCADE3_DIST = 96.0f;
...
const int MAX_SHADOWMAPS_TOTAL = 32;
const int MAX_PROBES_TOTAL = 32;
const int MAX_ELLIPSES_TOTAL = 64;
const int MAX_SKIN_XFORMS_TOTAL = 65536;
const int MAX_SKIN_REGIONS_TOTAL = 262144;
const int MAX_SKIN_VERTICES_TOTAL = 1048576;
