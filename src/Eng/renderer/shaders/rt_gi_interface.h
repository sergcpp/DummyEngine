...
const int RAY_MISS_STRIDE = 2;
const int RAY_LIST_STRIDE = 4;
...
const int SHADOW_DEPTH_TEX_SLOT = 18;
const int SHADOW_COLOR_TEX_SLOT = 19;
...
const int RAY_HITS_BUF_SLOT = 30;

const int OUT_GI_IMG_SLOT = 0;
const int OUT_RAY_HITS_BUF_SLOT = 1;
const int OUT_RAY_LIST_BUF_SLOT = 1;
