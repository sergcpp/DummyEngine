...
void Eng::RpOITScheduleRays::DrawTransparent(RpBuilder &builder, RpAllocTex &depth_tex) {
    ...
    RpAllocBuf &ray_counter_buf = builder.GetWriteBuffer(ray_counter_);
    RpAllocBuf &ray_list_buf = builder.GetWriteBuffer(ray_list_);
    ...
    ren_glBindTextureUnit_Comp(GL_TEXTURE_BUFFER, OITScheduleRays::OIT_DEPTH_BUF_SLOT, oit_depth_buf.tbos[0]->id());
