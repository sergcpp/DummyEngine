...
class Renderer {
  ...
  private:
    ...
    // SSR Denoiser stuff
    Ren::PipelineRef pi_ssr_reproject_, pi_ssr_prefilter_[2], pi_ssr_temporal_, pi_ssr_filter_[3], pi_ssr_stabilization_;
    // GI Cache
    ...
    // GI Denoiser stuff
    Ren::PipelineRef pi_gi_reproject_, pi_gi_prefilter_[2], pi_gi_temporal_, pi_gi_filter_[4], pi_gi_stabilization_;
    // Sun shadows
