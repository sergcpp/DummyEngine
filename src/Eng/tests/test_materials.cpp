...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        run_image_test(threads, "complex_mat0", 29.40, NoDiffGI);
        ...
        run_image_test(threads, "complex_mat1", 31.15, NoDiffGI);
        ...
        run_image_test(threads, "complex_mat2", 27.30, NoDiffGI);
        ...
        run_image_test(threads, "complex_mat2_sun_light", 21.25, Full);
    ...
    /*if (g_tests_success)*/ { // diffuse material
        ...
        run_image_test(threads, "diff_mat3", 23.60, Full);
        ...
        run_image_test(threads, "diff_mat4", 21.70, Full);
        ...
        run_image_test(threads, "diff_mat5", 23.35, Full);
    }
    puts(" ---------------");
    /*if (g_tests_success)*/ { // sheen material
        ...
        run_image_test(threads, "sheen_mat4", 21.45, Full);
        ...
        run_image_test(threads, "sheen_mat5", 20.55, Full);
        ...
        run_image_test(threads, "sheen_mat6", 20.25, Full);
        ...
        run_image_test(threads, "sheen_mat7", 19.60, Full);
    }
    puts(" ---------------");
    /*if (g_tests_success)*/ { // specular material
        ...
        run_image_test(threads, "spec_mat3", 22.20, Full_Ultra);
        ...
        run_image_test(threads, "spec_mat5", 29.05, NoDiffGI);
    ...
    /*if (g_tests_success)*/ { // metal material
        ...
        run_image_test(threads, "metal_mat2", 33.65, NoDiffGI);
        ...
        run_image_test(threads, "metal_mat3", 20.40, Full);
        run_image_test(threads, "metal_mat3", 21.85, Full_Ultra);
        ...
        run_image_test(threads, "metal_mat4", 18.65, Full);
        run_image_test(threads, "metal_mat4", 18.45, Full_Ultra);
        ...
        run_image_test(threads, "metal_mat5", 21.20, Full);
        run_image_test(threads, "metal_mat5", 21.20, Full_Ultra);
    }
    puts(" ---------------");
    /*if (g_tests_success)*/ { // plastic material
        ...
        run_image_test(threads, "plastic_mat3", 21.95, Full);
        ...
        run_image_test(threads, "plastic_mat4", 20.25, Full);
    ...
    /*if (g_tests_success)*/ { // tint material
        ...
        run_image_test(threads, "tint_mat1", 21.90, MedDiffGI);
        ...
        run_image_test(threads, "tint_mat3", 19.90, Full);
        ...
        run_image_test(threads, "tint_mat4", 21.60, MedDiffGI);
        run_image_test(threads, "tint_mat4", 17.10, Full);
    ...
    /*if (g_tests_success)*/ { // alpha material
        ...
        run_image_test(threads, "alpha_mat3", 29.50, Full_Ultra);
    }
}
