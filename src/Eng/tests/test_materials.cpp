...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.30, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 24.40, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 18.44, Full_Ultra));
