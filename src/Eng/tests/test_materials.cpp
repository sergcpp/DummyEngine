...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "visibility_flags", 24.21, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.15, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 19.40, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 19.90, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 20.04, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 19.52, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.81, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat4", 19.85, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 22.21, Full_Ultra));
