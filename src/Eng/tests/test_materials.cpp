...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 22.25, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 19.20, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 19.45, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 22.25, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_sun_light", 21.85, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // specular material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat5", 27.90, NoDiffGI));
    ...
    /*if (g_tests_success)*/ { // plastic material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 21.55, Full));
