...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "visibility_flags", 24.61, Full));
        futures.push_back(threads.Enqueue(run_image_test, "visibility_flags", 24.94, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "two_sided_mat", 27.81, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "two_sided_mat", 27.21, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.07, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 29.25, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2", 25.08, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2", 24.84, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_sun_light", 22.88, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 21.77, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 19.50, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 19.81, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 20.54, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 21.86, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 23.59, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 28.66, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 24.96, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 21.89, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 23.91, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 24.08, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 19.54, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 19.06, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 19.24, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 18.84, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 19.20, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 20.79, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.11, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.03, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.24, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.68, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 16.25, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 20.89, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 20.93, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat4", 19.79, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat4", 19.79, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat0", 23.38, Full));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat0", 23.33, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 22.14, Full));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 22.44, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // diffuse material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 47.24, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 33.88, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 32.14, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 28.43, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat1", 26.57, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat2", 28.40, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat3", 23.87, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat4", 21.90, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat5", 23.76, Full));
    ...
    /*if (g_tests_success)*/ { // sheen material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat0", 46.72, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat0", 34.55, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat0", 30.09, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat0", 29.21, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat1", 43.96, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat1", 34.32, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat1", 27.38, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat1", 26.84, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat2", 45.44, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat2", 34.24, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat2", 29.73, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat2", 27.80, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat3", 42.16, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat3", 33.88, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat3", 28.77, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat3", 26.47, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat4", 45.34, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat4", 35.92, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat4", 26.53, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat4", 21.97, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat5", 42.39, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat5", 35.46, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat5", 24.18, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat5", 20.97, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat6", 44.54, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat6", 35.40, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat6", 26.55, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat6", 20.67, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat7", 26.49, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat7", 19.95, Full));
    ...
    /*if (g_tests_success)*/ { // specular material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat0", 33.86, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat0", 26.83, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat0", 24.21, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat0", 24.04, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat0", 26.68, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 21.95, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 18.55, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 18.44, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 19.15, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 44.87, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 32.99, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 28.33, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 26.25, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 25.88, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 25.54, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 21.21, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 19.74, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 21.99, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat4", 22.08, NoDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat4", 14.81, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat5", 27.96, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat5", 20.26, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat5", 18.87, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat5", 18.65, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // metal material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 30.77, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 28.87, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 24.98, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 24.98, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 27.25, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 25.10, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 24.75, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 25.27, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 37.00, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 32.82, NoGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 29.87, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 29.95, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 21.34, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 19.82, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 22.08, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat4", 26.53, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat4", 20.64, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat4", 18.94, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat4", 18.70, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat5", 32.09, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat5", 25.58, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat5", 21.77, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat5", 21.80, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // plastic material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 43.73, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 33.66, NoGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 26.81, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 28.24, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat1", 24.49, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 41.82, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 32.61, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 31.51, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 30.33, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 26.53, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 27.71, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 22.02, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 23.76, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat4", 22.14, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat4", 20.54, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat4", 21.09, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 42.37, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 21.84, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 23.37, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // tint material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat0", 43.28, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat0", 26.37, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat1", 22.27, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat1", 20.86, Full));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat2", 39.96, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat2", 32.36, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat2", 30.72, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat2", 29.04, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat2", 25.50, Full));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 43.97, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 26.13, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 20.27, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat4", 22.52, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat4", 17.42, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat5", 29.28, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat5", 25.70, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat5", 18.03, Full));
    ...
    /*if (g_tests_success)*/ { // clearcoat material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "coat_mat0", 41.14, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "coat_mat0", 33.96, NoGI));
    ...
    /*if (g_tests_success)*/ { // alpha material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 37.22, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 25.01, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 22.73, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 22.09, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 22.55, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 22.39, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 38.44, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 24.43, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 23.41, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 22.76, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 23.34, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 23.20, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 41.34, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 26.92, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 26.80, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 26.33, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 27.12, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 27.02, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 47.09, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 36.71, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 36.71, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 34.16, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 29.46, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 30.68, Full_Ultra));
