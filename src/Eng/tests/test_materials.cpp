...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        run_image_test(threads, "two_sided_mat", 29.00, NoGI);
        run_image_test(threads, "two_sided_mat", 28.50, NoDiffGI);
        ...
        run_image_test(threads, "complex_mat0", 33.95, NoGI);
        run_image_test(threads, "complex_mat0", 28.70, NoDiffGI);
        ...
        run_image_test(threads, "complex_mat1", 33.50, NoGI);
        run_image_test(threads, "complex_mat1", 30.20, NoDiffGI);
        run_image_test(threads, "complex_mat1", 29.74, MedDiffGI);
        run_image_test(threads, "complex_mat1", 28.45, Full);
        run_image_test(threads, "complex_mat1", 28.80, Full_Ultra);
        run_image_test(threads, "complex_mat2", 33.90, NoShadow);
        run_image_test(threads, "complex_mat2", 31.90, NoGI);
        run_image_test(threads, "complex_mat2", 26.75, NoDiffGI);
        run_image_test(threads, "complex_mat2", 25.05, MedDiffGI);
        run_image_test(threads, "complex_mat2", 24.75, Full);
        run_image_test(threads, "complex_mat2", 27.30, Full_Ultra);
        ...
        run_image_test(threads, "complex_mat2_spot_light", 26.55, Full);
        ...
        run_image_test(threads, "complex_mat2_sun_light", 28.30, NoGI);
        run_image_test(threads, "complex_mat2_sun_light", 33.40, NoGI_RTShadow);
        run_image_test(threads, "complex_mat2_sun_light", 20.70, Full);
        ...
        run_image_test(threads, "complex_mat2_portal_sky", 23.90, Full);
        run_image_test(threads, "complex_mat2_portal_sky", 24.90, Full_Ultra);
        ...
        run_image_test(threads, "complex_mat2_mesh_lights", 21.65, Full_Ultra);
        run_image_test(threads, "complex_mat3", 24.25, NoShadow);
        run_image_test(threads, "complex_mat3", 21.60, NoGI);
        run_image_test(threads, "complex_mat3", 23.50, NoDiffGI);
        run_image_test(threads, "complex_mat3", 23.10, MedDiffGI);
        run_image_test(threads, "complex_mat3", 23.30, Full);
        run_image_test(threads, "complex_mat3", 23.70, Full_Ultra);
        run_image_test(threads, "complex_mat3_sun_light", 22.40, NoShadow);
        run_image_test(threads, "complex_mat3_sun_light", 17.55, NoGI);
        run_image_test(threads, "complex_mat3_sun_light", 22.70, NoGI_RTShadow);
        run_image_test(threads, "complex_mat3_sun_light", 19.20, Full);
        ...
        run_image_test(threads, "emit_mat0", 24.00, Full);
        run_image_test(threads, "emit_mat0", 24.65, Full_Ultra);
        run_image_test(threads, "emit_mat1", 22.75, Full);
        run_image_test(threads, "emit_mat1", 23.10, Full_Ultra);
    }
    ...
    /*if (g_tests_success)*/ { // diffuse material
        ...
        run_image_test(threads, "diff_mat0", 34.65, NoGI);
        run_image_test(threads, "diff_mat0", 31.50, MedDiffGI);
        run_image_test(threads, "diff_mat0", 28.55, Full);
        run_image_test(threads, "diff_mat1", 46.55, NoShadow);
        run_image_test(threads, "diff_mat1", 34.10, NoGI);
        run_image_test(threads, "diff_mat1", 29.80, MedDiffGI);
        run_image_test(threads, "diff_mat1", 26.85, Full);
        run_image_test(threads, "diff_mat2", 45.30, NoShadow);
        run_image_test(threads, "diff_mat2", 34.35, NoGI);
        run_image_test(threads, "diff_mat2", 31.30, MedDiffGI);
        run_image_test(threads, "diff_mat2", 28.40, Full);
        run_image_test(threads, "diff_mat3", 46.45, NoShadow);
        run_image_test(threads, "diff_mat3", 35.95, NoGI);
        run_image_test(threads, "diff_mat3", 26.25, MedDiffGI);
        run_image_test(threads, "diff_mat3", 23.70, Full);
        run_image_test(threads, "diff_mat4", 47.20, NoShadow);
        run_image_test(threads, "diff_mat4", 35.25, NoGI);
        run_image_test(threads, "diff_mat4", 25.40, MedDiffGI);
        run_image_test(threads, "diff_mat4", 21.80, Full);
        run_image_test(threads, "diff_mat5", 44.60, NoShadow);
        run_image_test(threads, "diff_mat5", 35.40, NoGI);
        run_image_test(threads, "diff_mat5", 26.25, MedDiffGI);
        run_image_test(threads, "diff_mat5", 23.45, Full);
    }
    puts(" ---------------");
    /*if (g_tests_success)*/ { // sheen material
        run_image_test(threads, "sheen_mat0", 46.55, NoShadow);
        run_image_test(threads, "sheen_mat0", 35.10, NoGI);
        ...
        run_image_test(threads, "sheen_mat1", 34.85, NoGI);
        ...
        run_image_test(threads, "sheen_mat2", 34.80, NoGI);
        ...
        run_image_test(threads, "sheen_mat3", 34.40, NoGI);
        run_image_test(threads, "sheen_mat3", 28.35, MedDiffGI);
        run_image_test(threads, "sheen_mat3", 26.45, Full);
        run_image_test(threads, "sheen_mat4", 45.20, NoShadow);
        run_image_test(threads, "sheen_mat4", 36.60, NoGI);
        run_image_test(threads, "sheen_mat4", 25.85, MedDiffGI);
        run_image_test(threads, "sheen_mat4", 21.55, Full);
        run_image_test(threads, "sheen_mat5", 42.30, NoShadow);
        run_image_test(threads, "sheen_mat5", 36.05, NoGI);
        run_image_test(threads, "sheen_mat5", 23.75, MedDiffGI);
        run_image_test(threads, "sheen_mat5", 20.60, Full);
        run_image_test(threads, "sheen_mat6", 44.40, NoShadow);
        run_image_test(threads, "sheen_mat6", 36.10, NoGI);
        run_image_test(threads, "sheen_mat6", 25.70, MedDiffGI);
        run_image_test(threads, "sheen_mat6", 20.35, Full);
        run_image_test(threads, "sheen_mat7", 40.10, NoShadow);
        run_image_test(threads, "sheen_mat7", 35.25, NoGI);
        run_image_test(threads, "sheen_mat7", 25.40, MedDiffGI);
        run_image_test(threads, "sheen_mat7", 19.70, Full);
    }
    puts(" ---------------");
    /*if (g_tests_success)*/ { // specular material
        run_image_test(threads, "spec_mat0", 40.10, NoShadow);
        run_image_test(threads, "spec_mat0", 33.85, NoGI);
        ...
        run_image_test(threads, "spec_mat1", 22.80, NoDiffGI);
        run_image_test(threads, "spec_mat1", 18.90, MedDiffGI);
        run_image_test(threads, "spec_mat1", 18.75, Full);
        run_image_test(threads, "spec_mat1", 19.35, Full_Ultra);
        run_image_test(threads, "spec_mat2", 44.75, NoShadow);
        run_image_test(threads, "spec_mat2", 33.95, NoGI);
        run_image_test(threads, "spec_mat2", 28.85, NoDiffGI);
        run_image_test(threads, "spec_mat2", 26.20, MedDiffGI);
        run_image_test(threads, "spec_mat2", 25.75, Full);
        run_image_test(threads, "spec_mat2", 25.45, Full_Ultra);
        run_image_test(threads, "spec_mat3", 36.40, NoShadow);
        run_image_test(threads, "spec_mat3", 33.60, NoGI);
        run_image_test(threads, "spec_mat3", 29.00, NoDiffGI);
        run_image_test(threads, "spec_mat3", 21.50, MedDiffGI);
        run_image_test(threads, "spec_mat3", 19.65, Full);
        run_image_test(threads, "spec_mat3", 22.25, Full_Ultra);
        run_image_test(threads, "spec_mat4", 21.00, NoShadow);
        run_image_test(threads, "spec_mat4", 21.10, NoGI);
        run_image_test(threads, "spec_mat4", 23.10, NoDiffGI);
        run_image_test(threads, "spec_mat4", 15.60, MedDiffGI);
        run_image_test(threads, "spec_mat4", 14.90, Full);
        run_image_test(threads, "spec_mat4", 14.70, Full_Ultra);
        ...
        run_image_test(threads, "spec_mat5", 20.15, MedDiffGI);
        run_image_test(threads, "spec_mat5", 18.65, Full);
        run_image_test(threads, "spec_mat5", 18.50, Full_Ultra);
    }
    puts(" ---------------");
    /*if (g_tests_success)*/ { // metal material
        run_image_test(threads, "metal_mat0", 32.65, NoShadow);
        run_image_test(threads, "metal_mat0", 30.75, NoGI);
        run_image_test(threads, "metal_mat0", 28.70, NoDiffGI);
        run_image_test(threads, "metal_mat0", 26.00, MedDiffGI);
        run_image_test(threads, "metal_mat0", 25.65, Full);
        run_image_test(threads, "metal_mat0", 28.10, Full_Ultra);
        run_image_test(threads, "metal_mat1", 23.60, NoShadow);
        run_image_test(threads, "metal_mat1", 23.20, NoGI);
        run_image_test(threads, "metal_mat1", 27.50, NoDiffGI);
        run_image_test(threads, "metal_mat1", 25.45, MedDiffGI);
        run_image_test(threads, "metal_mat1", 24.95, Full);
        run_image_test(threads, "metal_mat1", 25.10, Full_Ultra);
        run_image_test(threads, "metal_mat2", 37.00, NoShadow);
        run_image_test(threads, "metal_mat2", 32.80, NoGI);
        run_image_test(threads, "metal_mat2", 32.55, NoDiffGI);
        run_image_test(threads, "metal_mat2", 31.15, MedDiffGI);
        run_image_test(threads, "metal_mat2", 29.55, Full);
        run_image_test(threads, "metal_mat2", 29.65, Full_Ultra);
        run_image_test(threads, "metal_mat3", 38.05, NoShadow);
        run_image_test(threads, "metal_mat3", 34.35, NoGI);
        run_image_test(threads, "metal_mat3", 30.05, NoDiffGI);
        run_image_test(threads, "metal_mat3", 22.85, MedDiffGI);
        run_image_test(threads, "metal_mat3", 20.45, Full);
        run_image_test(threads, "metal_mat3", 21.90, Full_Ultra);
        run_image_test(threads, "metal_mat4", 25.25, NoShadow);
        run_image_test(threads, "metal_mat4", 25.20, NoGI);
        run_image_test(threads, "metal_mat4", 27.35, NoDiffGI);
        run_image_test(threads, "metal_mat4", 20.50, MedDiffGI);
        run_image_test(threads, "metal_mat4", 18.70, Full);
        run_image_test(threads, "metal_mat4", 18.55, Full_Ultra);
        run_image_test(threads, "metal_mat5", 37.30, NoShadow);
        run_image_test(threads, "metal_mat5", 33.80, NoGI);
        run_image_test(threads, "metal_mat5", 32.75, NoDiffGI);
        run_image_test(threads, "metal_mat5", 25.10, MedDiffGI);
        run_image_test(threads, "metal_mat5", 21.35, Full);
        run_image_test(threads, "metal_mat5", 21.35, Full_Ultra);
    }
    puts(" ---------------");
    /*if (g_tests_success)*/ { // plastic material
        run_image_test(threads, "plastic_mat0", 43.60, NoShadow);
        run_image_test(threads, "plastic_mat0", 34.35, NoGI);
        run_image_test(threads, "plastic_mat0", 32.00, NoDiffGI);
        run_image_test(threads, "plastic_mat0", 28.80, MedDiffGI);
        run_image_test(threads, "plastic_mat0", 27.05, Full);
        run_image_test(threads, "plastic_mat0", 28.20, Full_Ultra);
        run_image_test(threads, "plastic_mat1", 36.20, NoShadow);
        run_image_test(threads, "plastic_mat1", 32.70, NoGI);
        run_image_test(threads, "plastic_mat1", 28.00, NoDiffGI);
        run_image_test(threads, "plastic_mat1", 24.45, MedDiffGI);
        run_image_test(threads, "plastic_mat1", 23.40, Full);
        run_image_test(threads, "plastic_mat1", 23.65, Full_Ultra);
        run_image_test(threads, "plastic_mat2", 41.75, NoShadow);
        run_image_test(threads, "plastic_mat2", 33.50, NoGI);
        run_image_test(threads, "plastic_mat2", 32.65, NoDiffGI);
        run_image_test(threads, "plastic_mat2", 29.50, MedDiffGI);
        run_image_test(threads, "plastic_mat2", 26.75, Full);
        run_image_test(threads, "plastic_mat2", 28.00, Full_Ultra);
        ...
        run_image_test(threads, "plastic_mat3", 22.00, Full);
        run_image_test(threads, "plastic_mat3", 23.15, Full_Ultra);
        ...
        run_image_test(threads, "plastic_mat4", 22.10, MedDiffGI);
        run_image_test(threads, "plastic_mat4", 20.35, Full);
        run_image_test(threads, "plastic_mat4", 20.80, Full_Ultra);
        run_image_test(threads, "plastic_mat5", 42.30, NoShadow);
        run_image_test(threads, "plastic_mat5", 34.65, NoGI);
        run_image_test(threads, "plastic_mat5", 30.40, NoDiffGI);
        run_image_test(threads, "plastic_mat5", 25.45, MedDiffGI);
        run_image_test(threads, "plastic_mat5", 21.65, Full);
        run_image_test(threads, "plastic_mat5", 22.90, Full_Ultra);
    }
    puts(" ---------------");
    /*if (g_tests_success)*/ { // tint material
        run_image_test(threads, "tint_mat0", 43.20, NoShadow);
        run_image_test(threads, "tint_mat0", 34.30, NoGI);
        run_image_test(threads, "tint_mat0", 33.45, NoDiffGI);
        run_image_test(threads, "tint_mat0", 28.60, MedDiffGI);
        run_image_test(threads, "tint_mat0", 26.60, Full);
        run_image_test(threads, "tint_mat1", 28.65, NoShadow);
        run_image_test(threads, "tint_mat1", 27.65, NoGI);
        run_image_test(threads, "tint_mat1", 24.40, NoDiffGI);
        run_image_test(threads, "tint_mat1", 21.95, MedDiffGI);
        run_image_test(threads, "tint_mat1", 20.80, Full);
        run_image_test(threads, "tint_mat2", 40.45, NoShadow);
        run_image_test(threads, "tint_mat2", 33.15, NoGI);
        run_image_test(threads, "tint_mat2", 31.45, NoDiffGI);
        run_image_test(threads, "tint_mat2", 28.25, MedDiffGI);
        run_image_test(threads, "tint_mat2", 25.75, Full);
        run_image_test(threads, "tint_mat3", 43.90, NoShadow);
        run_image_test(threads, "tint_mat3", 35.65, NoGI);
        run_image_test(threads, "tint_mat3", 33.95, NoDiffGI);
        run_image_test(threads, "tint_mat3", 25.90, MedDiffGI);
        run_image_test(threads, "tint_mat3", 20.00, Full);
        ...
        run_image_test(threads, "tint_mat4", 21.65, MedDiffGI);
        run_image_test(threads, "tint_mat4", 17.15, Full);
        ...
        run_image_test(threads, "tint_mat5", 24.50, MedDiffGI);
        run_image_test(threads, "tint_mat5", 17.80, Full);
    }
    puts(" ---------------");
    /*if (g_tests_success)*/ { // clearcoat material
        run_image_test(threads, "coat_mat0", 41.05, NoShadow);
        run_image_test(threads, "coat_mat0", 34.40, NoGI);
        run_image_test(threads, "coat_mat1", 32.05, NoShadow);
        run_image_test(threads, "coat_mat1", 30.70, NoGI);
    ...
    /*if (g_tests_success)*/ { // alpha material
        ...
        run_image_test(threads, "alpha_mat2", 27.10, Full);
        ...
        run_image_test(threads, "alpha_mat3", 36.70, NoDiffGI);
        run_image_test(threads, "alpha_mat3", 32.65, MedDiffGI);
        run_image_test(threads, "alpha_mat3", 29.20, Full);
        run_image_test(threads, "alpha_mat3", 29.70, Full_Ultra);
    }
}
