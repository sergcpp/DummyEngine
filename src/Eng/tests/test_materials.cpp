...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 28.85, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 27.50, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.25, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.45, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.50, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.60, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 23.05, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // metal material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 30.10, NoDiffGI));
    ...
    /*if (g_tests_success)*/ { // plastic material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 26.35, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 27.50, Full_Ultra));
