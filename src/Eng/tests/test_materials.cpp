...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "two_sided_mat", 29.02, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "two_sided_mat", 28.51, NoDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 32.14, NoGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 29.79, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 19.23, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // diffuse material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat3", 25.75, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat4", 25.00, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat5", 25.80, MedDiffGI));
    ...
    /*if (g_tests_success)*/ { // specular material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 22.65, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // plastic material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 29.50, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 25.15, MedDiffGI));
    ...
    /*if (g_tests_success)*/ { // tint material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat0", 29.40, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 27.25, MedDiffGI));
    ...
    /*if (g_tests_success)*/ { // alpha material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 29.95, Full));
