...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 21.89, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 22.67, Full_Ultra));
