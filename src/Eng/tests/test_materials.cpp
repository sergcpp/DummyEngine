...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 18.70, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 18.70, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.88, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.35, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.50, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.95, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_sun_light", 18.30, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_sun_light", 21.75, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 16.90, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 20.00, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat0", 23.85, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // diffuse material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 29.15, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat1", 26.95, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat2", 29.05, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat3", 24.35, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat4", 22.35, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat5", 24.15, Full));
    ...
    /*if (g_tests_success)*/ { // sheen material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat2", 28.15, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat3", 26.85, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat4", 22.30, Full));
    ...
    /*if (g_tests_success)*/ { // specular material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat0", 23.20, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat0", 26.45, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 22.40, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 18.95, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 18.90, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 20.00, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 23.05, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat4", 22.70, NoDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat5", 28.50, NoDiffGI));
    ...
    /*if (g_tests_success)*/ { // metal material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 25.25, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 31.50, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 29.75, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 29.75, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 20.60, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 22.60, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat4", 27.00, NoDiffGI));
    ...
    /*if (g_tests_success)*/ { // plastic material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 28.00, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 29.25, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 26.85, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 28.65, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 22.70, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 24.00, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 25.50, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 22.25, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 23.60, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // tint material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat0", 27.75, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat2", 26.20, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 20.75, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat5", 17.85, Full));
    ...
    /*if (g_tests_success)*/ { // alpha material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 34.40, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 30.30, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 30.90, Full_Ultra));
