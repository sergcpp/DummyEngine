...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 25.97, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 22.33, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 18.77, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 18.36, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 18.45, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 20.89, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 21.20, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 22.33, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat0", 23.35, Full));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat0", 23.33, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 22.10, Full));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 22.40, Full_Ultra));
