...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.35, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_sun_light", 20.80, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_sun_light", 22.95, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 22.40, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 23.85, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 23.95, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 20.90, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 21.85, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 22.55, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 23.00, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_sun_light", 18.40, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 20.20, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 20.35, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat0", 24.05, Full));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat0", 23.85, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 22.80, Full));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 23.15, Full_Ultra));
