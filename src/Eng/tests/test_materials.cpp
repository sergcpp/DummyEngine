...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat4", 19.63, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat4", 19.57, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // diffuse material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 28.94, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat3", 24.46, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat5", 24.38, Full));
    ...
    /*if (g_tests_success)*/ { // sheen material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat6", 20.98, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat7", 20.26, Full));
    ...
    /*if (g_tests_success)*/ { // specular material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 22.11, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 18.57, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 18.57, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 19.48, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 28.34, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 26.31, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 25.96, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 25.81, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // metal material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 24.99, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 26.75, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 25.22, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 24.91, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 25.61, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 30.03, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 30.23, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat4", 26.73, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat4", 20.73, MedDiffGI));
    ...
    /*if (g_tests_success)*/ { // plastic material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat4", 22.25, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat4", 20.84, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat4", 21.50, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // tint material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat1", 22.31, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 20.63, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat4", 22.60, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat4", 17.71, Full));
    ...
    /*if (g_tests_success)*/ { // alpha material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 31.40, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 30.45, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 30.45, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 29.68, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 27.30, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 28.00, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 32.36, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 26.54, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 26.24, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 26.52, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 24.30, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 24.51, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 34.75, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 26.92, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 27.27, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 26.59, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 27.30, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 27.84, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 30.11, Full_Ultra));
