...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 29.02, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 28.24, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 28.92, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_spot_light", 26.77, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_spot_light", 26.89, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_spot_light", 27.98, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_sun_light", 21.48, Full));
