...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "two_sided_mat", 39.83, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "two_sided_mat", 28.05, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "two_sided_mat", 27.30, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 38.55, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 33.95, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 28.70, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 27.20, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.05, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.30, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 35.84, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 33.50, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 30.20, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 29.74, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat1", 28.45, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2", 26.75, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2", 25.05, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2", 24.75, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2", 27.30, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_spot_light", 30.45, NoDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_sun_light", 20.70, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_sun_light", 22.80, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 22.85, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 22.70, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_moon_light", 23.20, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 20.80, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 22.15, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_hdri_light", 23.60, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 27.25, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 24.40, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 24.50, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 23.90, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_hdri", 24.90, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 23.55, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 23.90, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_portal_sky", 24.90, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 20.45, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 20.70, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_mesh_lights", 21.65, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 23.50, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 23.10, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 23.30, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3", 23.75, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_sun_light", 19.20, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_sun_light", 23.35, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 16.90, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 20.50, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat3_mesh_lights", 20.65, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat4", 19.65, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat4", 19.65, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat0", 24.00, Full));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat0", 24.65, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 22.75, Full));
        futures.push_back(threads.Enqueue(run_image_test, "emit_mat1", 23.10, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // diffuse material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 47.05, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 34.65, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 31.50, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat0", 28.55, Full));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat1", 46.55, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat1", 34.10, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat1", 29.80, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat1", 26.85, Full));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat2", 45.30, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat2", 34.35, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat2", 31.30, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat2", 28.40, Full));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat3", 46.45, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat3", 35.95, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat3", 26.25, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat3", 23.70, Full));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat4", 47.20, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat4", 35.25, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat4", 25.40, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat4", 21.80, Full));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat5", 44.60, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat5", 35.40, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "diff_mat5", 26.25, MedDiffGI));
    ...
    /*if (g_tests_success)*/ { // sheen material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat0", 46.55, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat0", 35.10, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat0", 30.35, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat0", 28.85, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat1", 43.85, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat1", 26.60, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat2", 45.30, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat2", 34.80, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat2", 29.55, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat2", 27.65, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat3", 42.10, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat3", 34.40, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat3", 28.35, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat3", 26.45, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat4", 45.20, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat4", 36.60, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat4", 25.85, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat4", 21.55, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat5", 42.30, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat5", 36.05, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat5", 23.75, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat5", 20.60, Full));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat6", 44.40, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat6", 36.10, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat6", 25.70, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat6", 20.35, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat7", 25.40, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "sheen_mat7", 19.70, Full));
    ...
    /*if (g_tests_success)*/ { // specular material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat0", 27.50, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 22.90, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 18.95, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 18.85, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat1", 19.50, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 44.75, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 33.95, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 28.85, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 26.20, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat2", 25.75, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 21.50, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 19.65, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 22.25, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat4", 23.30, NoDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat5", 29.15, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat5", 20.15, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat5", 18.70, Full));
    ...
    /*if (g_tests_success)*/ { // metal material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 28.70, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 26.00, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 25.65, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 27.65, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 25.55, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat1", 25.05, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 32.55, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 31.15, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 29.60, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat2", 29.70, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 30.05, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 22.85, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 20.45, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 21.90, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat4", 27.50, NoDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat5", 32.75, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat5", 25.10, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat5", 21.40, Full));
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat5", 21.40, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // plastic material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 43.60, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 28.80, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 27.05, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 28.20, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat1", 36.20, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat1", 32.70, NoGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 41.75, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 29.50, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 26.75, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 28.00, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 38.45, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 34.35, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 31.45, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 24.80, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 22.00, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat3", 23.15, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat4", 20.80, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 42.30, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 34.65, NoGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 30.40, NoDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 25.45, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 21.65, Full));
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat5", 22.90, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // tint material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat0", 43.20, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat0", 28.60, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat0", 26.60, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat1", 21.95, MedDiffGI));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat2", 28.25, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat2", 25.75, Full));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 43.90, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 25.90, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 20.00, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat4", 21.65, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat4", 17.15, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat5", 24.50, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat5", 17.80, Full));
    ...
    /*if (g_tests_success)*/ { // clearcoat material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "coat_mat0", 41.05, NoShadow));
        futures.push_back(threads.Enqueue(run_image_test, "coat_mat0", 34.40, NoGI));
    ...
    /*if (g_tests_success)*/ { // alpha material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 37.15, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 22.55, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat0", 22.50, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 23.25, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 23.30, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat1", 23.65, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 26.95, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 27.10, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat2", 27.50, Full_Ultra));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 46.85, NoShadow));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 32.65, MedDiffGI));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 29.20, Full));
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 29.70, Full_Ultra));
