...
void test_materials(Sys::ThreadPool &threads, const bool full, std::string_view device_name, const int vl,
    ...
    { // complex materials
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.15, Full));
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat0", 26.40, Full_Ultra));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "complex_mat2_sun_light", 23.00, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // specular material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 20.20, Full));
        futures.push_back(threads.Enqueue(run_image_test, "spec_mat3", 23.30, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // metal material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat0", 25.75, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "metal_mat3", 22.70, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // plastic material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat0", 27.35, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "plastic_mat2", 28.10, Full_Ultra));
    ...
    /*if (g_tests_success)*/ { // tint material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat0", 26.90, Full));
        ...
        futures.push_back(threads.Enqueue(run_image_test, "tint_mat3", 20.80, Full));
    ...
    /*if (g_tests_success)*/ { // alpha material
        ...
        futures.push_back(threads.Enqueue(run_image_test, "alpha_mat3", 30.00, Full_Ultra));
