...
void test_shading(Sys::ThreadPool &threads, const bool full) {
    ...
    run_image_test(ren_ctx, threads, "diff_mat2", 31.05, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "metal_mat2", 31.15, MedDiffGI);
    run_image_test(ren_ctx, threads, "metal_mat2", 29.40, Full);
    ...
    run_image_test(ren_ctx, threads, "plastic_mat2", 28.95, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "plastic_mat3", 24.60, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "plastic_mat4", 21.90, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "plastic_mat5", 25.40, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "alpha_mat0", 25.55, NoDiffGI);
    run_image_test(ren_ctx, threads, "alpha_mat0", 24.75, MedDiffGI);
    run_image_test(ren_ctx, threads, "alpha_mat0", 24.80, Full);
    run_image_test(ren_ctx, threads, "alpha_mat0", 24.00, Full_Ultra);
    ...
    run_image_test(ren_ctx, threads, "alpha_mat1", 26.95, MedDiffGI);
    run_image_test(ren_ctx, threads, "alpha_mat1", 27.00, Full);
    run_image_test(ren_ctx, threads, "alpha_mat1", 26.45, Full_Ultra);
    ...
    run_image_test(ren_ctx, threads, "alpha_mat2", 32.00, MedDiffGI);
    run_image_test(ren_ctx, threads, "alpha_mat2", 30.65, Full);
    run_image_test(ren_ctx, threads, "alpha_mat2", 31.10, Full_Ultra);
