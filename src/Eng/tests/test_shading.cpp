...
void test_shading(Sys::ThreadPool &threads, const bool full) {
    ...
    run_image_test(ren_ctx, threads, "visibility_flags_sun", 25.70, Full_Ultra);
    run_image_test(ren_ctx, threads, "two_sided_mat", 27.10, MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat0", 26.80, MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat0", 25.95, Full);
    run_image_test(ren_ctx, threads, "complex_mat0", 26.25, Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat1", 29.45, MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat1", 28.40, Full);
    run_image_test(ren_ctx, threads, "complex_mat1", 28.85, Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat2", 24.80, MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat2", 24.70, Full);
    run_image_test(ren_ctx, threads, "complex_mat2", 26.95, Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat2_area_spread", 17.10, NoDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat2_area_spread", 18.20, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "complex_mat2_emissive", 18.85, Full);
    run_image_test(ren_ctx, threads, "complex_mat2_emissive", 17.80, Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat2_dyn",
                   std::vector<double>{24.00, 24.00, 23.90, 23.85, 23.80, 23.70, 23.65, 23.60, 23.50, 23.35, //
                                       23.15, 23.10, 23.00, 22.90, 22.80, 22.85, 22.95, 23.00, 23.00, 23.05,
                                       23.15, 23.30, 23.30, 23.40, 23.35, 23.60, 23.65, 23.85, 24.05, 24.10,
                                       24.20, 24.20, 24.35},
                   MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat2_dyn",
                   std::vector<double>{23.25, 23.30, 23.25, 23.25, 23.25, 23.25, 23.25, 23.25, 23.20, 23.10, //
                                       23.00, 22.95, 22.90, 22.80, 22.70, 22.75, 22.80, 22.90, 22.85, 22.95,
                                       22.95, 23.20, 23.20, 23.30, 23.25, 23.35, 23.55, 23.75, 23.95, 24.00,
                                       24.10, 24.10, 24.30},
                   Full);
    run_image_test(ren_ctx, threads, "complex_mat2_dyn",
                   std::vector<double>{24.25, 24.25, 24.15, 24.10, 24.00, 23.90, 23.85, 23.85, 23.80, 23.70, //
                                       23.60, 23.55, 23.50, 23.40, 23.30, 23.35, 23.40, 23.35, 23.25, 23.30,
                                       23.30, 23.55, 23.50, 23.60, 23.50, 23.60, 23.80, 24.00, 24.20, 24.25,
                                       24.35, 24.35, 24.55},
                   Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat2_far_away", 24.80, MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat2_far_away", 24.75, Full);
    run_image_test(ren_ctx, threads, "complex_mat2_far_away", 27.10, Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat2_spot_light", 27.00, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "complex_mat2_sun_light_dyn",
                   std::vector<double>{33.40, 33.70, 33.80, 33.70, 33.55, 33.15, 32.65, 32.05, 31.30, 30.35, //
                                       28.95, 27.85, 26.75, 25.15, 23.70, 22.25, 20.20, 21.85, 23.10, 24.15,
                                       25.20, 25.95, 25.60, 26.95, 26.55, 27.75, 28.20, 27.80, 29.20, 29.35,
                                       29.35, 30.10, 30.50},
                   Full);
    run_image_test(ren_ctx, threads, "complex_mat2_sun_light_dyn",
                   std::vector<double>{33.50, 33.80, 33.55, 33.45, 33.70, 33.50, 32.95, 31.90, 31.45, 30.40, //
                                       29.35, 28.15, 26.95, 25.70, 24.05, 22.60, 20.80, 22.05, 23.25, 24.25,
                                       25.10, 26.10, 26.00, 27.10, 26.70, 27.95, 28.35, 27.90, 29.40, 29.50,
                                       29.55, 30.25, 30.70},
                   Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat2_moon_light", 23.45, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "complex_mat2_portal_hdri", 24.10, MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat2_portal_hdri", 23.80, Full);
    run_image_test(ren_ctx, threads, "complex_mat2_portal_hdri", 24.60, Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat2_portal_sky", 22.55, MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat2_portal_sky", 24.10, Full);
    run_image_test(ren_ctx, threads, "complex_mat2_portal_sky", 24.80, Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat2_mesh_lights", 20.45, MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat2_mesh_lights", 21.30, Full);
    run_image_test(ren_ctx, threads, "complex_mat2_mesh_lights", 22.35, Full_Ultra);
    run_image_test(ren_ctx, threads, "complex_mat3", 22.25, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "complex_mat3_dyn",
                   std::vector<double>{22.25, 22.25, 22.25, 22.30, 22.30, 22.30, 22.30, 22.30, 22.30, 22.35, //
                                       22.35, 22.35, 22.35, 22.35, 22.40, 22.40, 22.40, 22.45, 22.45, 22.45,
                                       22.45, 22.45, 22.45, 22.45, 22.45, 22.50, 22.50, 22.50, 22.50, 22.50,
                                       22.50, 22.50, 22.55},
                   MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat3_dyn",
                   std::vector<double>{22.20, 22.25, 22.25, 22.30, 22.30, 22.30, 22.30, 22.35, 22.35, 22.40, //
                                       22.40, 22.40, 22.40, 22.40, 22.45, 22.45, 22.50, 22.50, 22.50, 22.50,
                                       22.55, 22.55, 22.55, 22.55, 22.55, 22.60, 22.60, 22.60, 22.60, 22.60,
                                       22.60, 22.65, 22.65},
                   Full);
    run_image_test(ren_ctx, threads, "complex_mat3_dyn",
                   std::vector<double>{22.70, 22.70, 22.75, 22.75, 22.75, 22.80, 22.80, 22.80, 22.85, 22.85, //
                                       22.90, 22.90, 22.90, 22.90, 22.95, 23.00, 23.00, 23.00, 23.05, 23.05,
    ...
    run_image_test(ren_ctx, threads, "complex_mat3_mesh_lights", 18.25, MedDiffGI);
    run_image_test(ren_ctx, threads, "complex_mat3_mesh_lights", 20.80, Full);
    run_image_test(ren_ctx, threads, "complex_mat3_mesh_lights", 20.80, Full_Ultra);
    ...
    run_image_test(ren_ctx, threads, "spec_mat2", 25.80, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "spec_mat3", 21.10, MedDiffGI);
    run_image_test(ren_ctx, threads, "spec_mat3", 19.10, Full);
    run_image_test(ren_ctx, threads, "spec_mat3", 20.75, Full_Ultra);
    ...
    run_image_test(ren_ctx, threads, "metal_mat2", 30.40, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "metal_mat3", 21.15, Full_Ultra);
    ...
    run_image_test(ren_ctx, threads, "metal_mat5", 24.40, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "plastic_mat0", 27.95, Full_Ultra);
    run_image_test(ren_ctx, threads, "plastic_mat1", 33.45, NoGI);
    run_image_test(ren_ctx, threads, "plastic_mat1", 27.90, NoDiffGI);
    run_image_test(ren_ctx, threads, "plastic_mat1", 23.80, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "plastic_mat3", 22.30, Full_Ultra);
    ...
    run_image_test(ren_ctx, threads, "plastic_mat5", 25.25, MedDiffGI);
    run_image_test(ren_ctx, threads, "plastic_mat5", 20.90, Full);
    ...
    run_image_test(ren_ctx, threads, "tint_mat4", 21.35, MedDiffGI);
    ...
    run_image_test(ren_ctx, threads, "alpha_mat3", 28.60, Full);
