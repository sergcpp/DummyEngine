...
void test_upscaling(Sys::ThreadPool &threads) {
    ...
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{21.95, 21.95, 21.95, 21.85, 21.85, 21.75, 21.80, 21.75, 21.75, 21.80, //
                                       21.60, 21.60, 21.60, 21.55, 21.45, 21.45, 21.55, 21.55, 21.60, 21.65,
                                       21.80, 21.80, 21.85, 21.75, 21.70, 21.80, 21.80, 21.90, 22.00, 22.05,
                                       22.20, 22.20, 22.25},
                   Full, 1.5f);
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{22.35, 22.35, 22.30, 22.20, 22.15, 22.00, 22.00, 21.95, 21.95, 22.05, //
                                       21.90, 21.90, 21.90, 21.85, 21.75, 21.75, 21.80, 21.80, 21.75, 21.85,
                                       21.95, 21.95, 22.00, 21.90, 21.75, 21.90, 21.85, 21.95, 22.05, 22.10,
                                       22.30, 22.25, 22.25},
                   Full_Ultra, 1.5f);
    ///
