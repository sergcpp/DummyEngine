...
void test_upscaling(Sys::ThreadPool &threads) {
    ...
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{23.70, 23.65, 23.40, 23.30, 22.90, 22.90, 22.65, 22.55, 22.35, 22.15, //
                                       21.90, 21.80, 21.70, 21.65, 21.45, 21.55, 21.45, 21.60, 21.60, 21.70,
    ...
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{22.60, 22.60, 22.50, 22.45, 22.35, 22.30, 22.15, 22.20, 22.10, 22.00, //
                                       21.85, 21.80, 21.75, 21.70, 21.55, 21.75, 21.70, 21.85, 21.80, 21.90,
                                       21.95, 22.05, 22.05, 22.00, 21.85, 21.95, 22.00, 22.15, 22.30, 22.35,
                                       22.50, 22.60, 22.65},
                   Full, 1.5f);
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{23.35, 23.35, 23.10, 23.05, 22.90, 22.75, 22.60, 22.55, 22.45, 22.45, //
                                       22.25, 22.25, 22.15, 22.10, 21.95, 22.10, 22.05, 22.15, 22.05, 22.10,
