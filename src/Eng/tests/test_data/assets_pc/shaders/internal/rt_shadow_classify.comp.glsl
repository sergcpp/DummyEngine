...
#define LOCAL_GROUP_SIZE_Y 4

#define DEPTH_TEX_SLOT 2
#define NORM_TEX_SLOT 3
#define TILE_COUNTER_SLOT 5
#define TILE_LIST_SLOT 6
#define SOBOL_BUF_SLOT 7
#define SCRAMLING_TILE_BUF_SLOT 8
#define RANKING_TILE_BUF_SLOT 9

#define RAY_HITS_IMG_SLOT 0
