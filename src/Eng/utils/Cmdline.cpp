...
void Eng::Cmdline::RegisterCommand(std::string_view cmd, const CommandHandler &handler) {
    cmd_handlers_[Ren::String{cmd}] = handler;
}

bool Eng::Cmdline::Execute(std::string_view str) {
...
int Eng::Cmdline::NextHint(std::string_view str, const int i, Ren::String &out_str) const {
...
bool Eng::Cmdline::Parse(std::string_view str, Ren::SmallVectorImpl<ArgData> &out_args) {
