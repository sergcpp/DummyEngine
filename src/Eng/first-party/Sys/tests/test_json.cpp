...
static const char json_example4[] =
...
void test_json() {
    ...
    AGAIN2:
        ...
        require(text["onMouseUp"] == JsStringP("sun1.opacity = (sun1.opacity / 100) * 90;", my_alloc));
    ...
    AGAIN3:
        ...
        require(gloss_def["para"] ==
                JsString{"A meta-markup language, used to create markup languages such as DocBook."});
    ...
    AGAIN4:
        ...
        require(gloss_entry["GlossTerm"] == JsStringP("Standard Generalized Markup Language", my_alloc));
    ...
    { // Complex test4
        bool flag = true;
        JsElement el(JsLiteralType::Null);
        std::stringstream ss(json_example4);

    AGAIN7:
        require(el.Read(ss));

        JsArray &root = el.as_arr();
        require(root.Size() == 7);
        require(root[0].as_str().val == "Sunday");
        require(root[1].as_str().val == "Monday");
        require(root[2].as_str().val == "Tuesday");
        require(root[3].as_str().val == "Wednesday");
        require(root[4].as_str().val == "Thursday");
        require(root[5].as_str().val == "Friday");
        require(root[6].as_str().val == "Saturday");
