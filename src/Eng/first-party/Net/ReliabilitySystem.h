...
namespace Net {
    ...
    public:
        explicit ReliabilitySystem(unsigned int max_sequence = 0xFFFFFFFF);
        ...
        static unsigned int
        generate_ack_bits(unsigned int ack, const PacketQueue &received_queue, unsigned int max_sequence);
