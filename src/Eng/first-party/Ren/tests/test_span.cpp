...
void test_span() {
    ...
    { // basic usage
        ...
        Ren::Span<const int> test0;
        require(test0.empty());
        require(test0.size() == 0);

        Ren::Span<const int> test1 = {data, 3};
        require(!test1.empty());
        ...
        Ren::Span<const int> test2 = {data, data + 3};
        require(!test2.empty());
        ...
        Ren::Span<const int> test4 = test3;
        require(!test4.empty());
        ...
        Ren::Span<int> test7(data2);
        Ren::Span<const int> test8 = test7;
        require(test8[0] == 1);
        require(test8[1] == 2);
        require(test8[2] == 3);
    }
