...
float PerlinNoise4D(const Vec4f &P);
float PerlinNoise4D(const Vec4f &P, const Vec4f &rep);

float PerlinNoise3D_Perm(const Vec3f &P);

float SimplexNoise3D_Perm(const Vec3f &P);
float SimplexNoise3D_Rand(const Vec3f &P);
