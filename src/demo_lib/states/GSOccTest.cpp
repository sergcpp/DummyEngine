...
GSOccTest::GSOccTest(GameBase *game) : game_(game),
	...
	swCullCtxInit(&cull_ctx_, 512, 256);
...
void GSOccTest::Draw(float dt_s) {
	...
	auto set_bbox = [](const float pos[3], float attribs[144]) {
		...
		attribs[0] = _min[0];	attribs[1] = _min[1];	attribs[2] = _min[2];		attribs[3] = 0; attribs[4] = -1; attribs[5] = 0;
		attribs[6] = _max[0];	attribs[7] = _min[1];	attribs[8] = _min[2];		attribs[9] = 0;	attribs[10] = -1; attribs[11] = 0;
		attribs[12] = _max[0];	attribs[13] = _min[1];	attribs[14] = _max[2];		attribs[15] = 0; attribs[16] = -1; attribs[17] = 0;
		attribs[18] = _min[0];	attribs[19] = _min[1];	attribs[20] = _max[2];		attribs[21] = 0; attribs[22] = -1; attribs[23] = 0;

		attribs[24] = _min[0];	attribs[25] = _max[1];	attribs[26] = _min[2];		attribs[27] = 0; attribs[28] = 1; attribs[29] = 0;
		attribs[30] = _max[0];	attribs[31] = _max[1];	attribs[32] = _min[2];		attribs[33] = 0; attribs[34] = 1; attribs[35] = 0;
		attribs[36] = _max[0];	attribs[37] = _max[1];	attribs[38] = _max[2];		attribs[39] = 0; attribs[40] = 1; attribs[41] = 0;
		attribs[42] = _min[0];	attribs[43] = _max[1];	attribs[44] = _max[2];		attribs[45] = 0; attribs[46] = 1; attribs[47] = 0;

		attribs[48] = _min[0];	attribs[49] = _min[1];	attribs[50] = _min[2];		attribs[51] = 1; attribs[52] = 0; attribs[53] = 0;
		attribs[54] = _min[0];	attribs[55] = _max[1];	attribs[56] = _min[2];		attribs[57] = 1; attribs[58] = 0; attribs[59] = 0;
		attribs[60] = _min[0];	attribs[61] = _max[1];	attribs[62] = _max[2];		attribs[63] = 1; attribs[64] = 0; attribs[65] = 0;
		attribs[66] = _min[0];	attribs[67] = _min[1];	attribs[68] = _max[2];		attribs[69] = 1; attribs[70] = 0; attribs[71] = 0;

		attribs[72] = _max[0];	attribs[73] = _min[1];	attribs[74] = _min[2];		attribs[75] = -1; attribs[76] = 0; attribs[77] = 0;
		attribs[78] = _max[0];	attribs[79] = _max[1];	attribs[80] = _min[2];		attribs[81] = -1; attribs[82] = 0; attribs[83] = 0;
		attribs[84] = _max[0];	attribs[85] = _max[1];	attribs[86] = _max[2];		attribs[87] = -1; attribs[88] = 0; attribs[89] = 0;
		attribs[90] = _max[0];	attribs[91] = _min[1];	attribs[92] = _max[2];		attribs[93] = -1; attribs[94] = 0; attribs[95] = 0;

		attribs[96] = _min[0];	attribs[97] = _min[1];	attribs[98] = _min[2];		attribs[99] = 0; attribs[100] = 0; attribs[101] = 1;
		attribs[102] = _max[0];	attribs[103] = _min[1];	attribs[104] = _min[2];		attribs[105] = 0; attribs[106] = 0; attribs[107] = 1;
		attribs[108] = _max[0];	attribs[109] = _max[1];	attribs[110] = _min[2];		attribs[111] = 0; attribs[112] = 0; attribs[113] = 1;
		attribs[114] = _min[0];	attribs[115] = _max[1];	attribs[116] = _min[2];		attribs[117] = 0; attribs[118] = 0; attribs[119] = 1;

		attribs[120] = _min[0];	attribs[121] = _min[1];	attribs[122] = _max[2];		attribs[123] = 0; attribs[124] = 0; attribs[125] = -1;
		attribs[126] = _max[0];	attribs[127] = _min[1];	attribs[128] = _max[2];		attribs[129] = 0; attribs[130] = 0; attribs[131] = -1;
		attribs[132] = _max[0];	attribs[133] = _max[1];	attribs[134] = _max[2];		attribs[135] = 0; attribs[136] = 0; attribs[137] = -1;
		attribs[138] = _min[0];	attribs[139] = _max[1];	attribs[140] = _max[2];		attribs[141] = 0; attribs[142] = 0; attribs[143] = -1;
	};
...

	{
		...
		{	// draw secondary view
			...
			glViewport(0, game_->height - 256, 512, 256);
			glScissor(0, game_->height - 256, 512, 256);
