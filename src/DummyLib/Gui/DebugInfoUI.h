...
class DebugInfoUI : public Gui::BaseElement {
    ...
    struct {
        float occluders_time_ms = 0.0f, main_gather_time_ms = 0.0f,
              shadow_gather_time_ms = 0.0f, drawables_sort_time_ms = 0.0f,
    ...
    struct {
        float skinning_time_ms = 0.0f, vegetation_time_ms = 0.0f, shadow_time_ms = 0.0f,
              depth_opaque_pass_time_ms = 0.0f, ao_pass_time_ms = 0.0f,
              opaque_pass_time_ms = 0.0f, transp_pass_time_ms = 0.0f,
              refl_pass_time_ms = 0.0f, taa_pass_time_ms = 0.0f, blur_pass_time_ms = 0.0f,
              blit_pass_time_ms = 0.0f;

        float cpu_total_ms = 0.0f, gpu_total_ms = 0.0f;

        float shadow_draw_calls_count = 0.0f, depth_fill_draw_calls_count = 0.0f,
  ...
  public:
    ...
    void UpdateInfo(const FrontendInfo &frontend_info, const BackendInfo &backend_info,
                    const ItemsInfo &items_info, const TimeInterval &swap_interval,
