...
#if defined(MSAA_4)
layout(binding = )" AS_STR(REN_DIFF_TEX_SLOT) R"() uniform highp sampler2DMS depth_texture;
#else
layout(binding = )" AS_STR(REN_DIFF_TEX_SLOT) R"() uniform highp sampler2D depth_texture;
#endif
