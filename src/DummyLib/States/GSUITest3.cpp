...
const char SCENE_NAME[] = "assets_pc/scenes/"
    ...
    const Ren::Vec3f page_corners_pos[] = {
        Ren::Vec3f{ 0.378295f, 0.065051f, 0.525073f }, Ren::Vec3f{ -0.369601f, 0.059627f, 0.04203f },
    };
...

    {
...

        {
            ...
            paged_reader_.reset(new PagedReader{
                    *ctx_, Ren::Vec2f{ -0.995f, -0.995f }, Ren::Vec2f{ 2.0f, 2.0f }, &page_root,
...
void GSUITest3::Draw(uint64_t dt_us) {
    ...
    scene_manager_->SetupView(
        view_origin, (view_origin + view_dir_), up_vector, view_fov_, max_exposure_);
...
Sys::Optional<Ren::Vec2f> GSUITest3::MapPointToPageFramebuf(const Ren::Vec2f &p) {
    ...
    const Mat4f
            &clip_from_view = cam.proj_matrix(),
            &view_from_world = cam.view_matrix();
    ...
    if (inter_point[0] < page_corners_pos[0][0] && inter_point[0] > page_corners_pos[1][0] &&
        ...
        inter_point_norm /= Vec2f{ page_corners_pos[0][0] - page_corners_pos[1][0], page_corners_pos[0][2] - page_corners_pos[1][2] };
